		 ...
		 if(map.get("Q4")!=null){
			...
			int standard = 1;
	 		if(factor>=0 && factor<=3)
	 			...
	 			standard = 6;
	 		else if(factor>=15 && factor<=17)
	 			standard = 7;
	 		else if(factor>=18 && factor<=20)
	 			standard = 8;
	 		else if(factor>=21 && factor<=22)
	 			standard = 9;
	 		else standard = 10;
